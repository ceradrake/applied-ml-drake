...
GitHub link to Jupyter notebook: <https://github.com/ceradrake/applied-ml-drake/blob/main/midterm/MushroomClassification.ipynb>

Clickable link to my peer revew: <https://github.com/ceradrake/applied-ml-drake/blob/main/midterm/PeerReview.md>

## Overview of my midterm
We are going to follow the below steps using the Mushroom Dataset. I want to compare different features to whether or not they are indicative of a mushroom being poisonous or edible. 
